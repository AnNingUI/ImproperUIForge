...
import org.anningui.iui_forge.util.MathUtils;
...
//        getChildren().forEach(child -> child.onRender(context, mx, my, delta));
    ...
    public String toString() {
        ...
        arr.add(new JsonPrimitive(y     ));
        arr.add(new JsonPrimitive(width ));
        arr.add(new JsonPrimitive(height));
        o.add("dimensions", arr);

        arr = new JsonArray();
        arr.add(new JsonPrimitive(marginLeft  ));
        arr.add(new JsonPrimitive(marginRight ));
        arr.add(new JsonPrimitive(marginTop   ));
        arr.add(new JsonPrimitive(marginBottom));
        o.add("margin", arr);

        arr = new JsonArray();
        arr.add(new JsonPrimitive(paddingLeft  ));
        arr.add(new JsonPrimitive(paddingRight ));
        arr.add(new JsonPrimitive(paddingTop   ));
        arr.add(new JsonPrimitive(paddingBottom));
        o.add("padding", arr);

        arr = new JsonArray();
        arr.add(new JsonPrimitive(borderThickness));
        arr.add(new JsonPrimitive(borderRadius));
        arr.add(new JsonPrimitive(stringify(borderColor)));
        o.add("border", arr);

        arr = new JsonArray();
        arr.add(new JsonPrimitive(stringify(fillColor)      ));
        arr.add(new JsonPrimitive(stringify(backgroundClip) ));
        arr.add(new JsonPrimitive(stringify(backgroundImage)));
        arr.add(new JsonPrimitive(opacity                   ));
        o.add("background", arr);

        arr = new JsonArray();
        arr.add(new JsonPrimitive(shadowDistance));
        arr.add(new JsonPrimitive(stringify(shadowColor)));
        arr.add(new JsonPrimitive(stringify(shadowFadeColor)));
        o.add("shadow", arr);

        arr = new JsonArray();
        arr.add(new JsonPrimitive(clickAction));
        arr.add(new JsonPrimitive(scrollAction));
        arr.add(new JsonPrimitive(keyAction));
        o.add("callbacks", arr);

        arr = new JsonArray();
        arr.add(new JsonPrimitive(textScale));
        arr.add(new JsonPrimitive(stringify(textAlignment)));
        arr.add(new JsonPrimitive(innerText));
        arr.add(new JsonPrimitive(innerTextPrefix));
        arr.add(new JsonPrimitive(innerTextSuffix));
        arr.add(new JsonPrimitive(textShadow));
        arr.add(new JsonPrimitive(stringify(textColor)));
        o.add("text", arr);

        arr = new JsonArray();
        arr.add(new JsonPrimitive(stringify(childrenAlignment)));
        arr.add(new JsonPrimitive(stringify(childrenConstraint)));
        arr.add(new JsonPrimitive(gridColumns));
        o.add("child-align", arr);

        arr = new JsonArray();
        arr.add(new JsonPrimitive(rotateX));
        arr.add(new JsonPrimitive(rotateY));
        arr.add(new JsonPrimitive(rotateZ));
        o.add("rotation", arr);
